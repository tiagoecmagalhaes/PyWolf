...
def func_startSim(ui,all_parameters):
    ...
    if start_prop==1:
        ...
        try:
            ...
            ui.canvasSI = Canvas_sourceImage(ui,ui.CSDM_source.matrix,N,title="Source Image")
        ...
        try:
            ...
            if propQuantity==0:
                ...
                try:
                    ...
                    ui.canvasPI = Canvas_sourceImage(ui,ui.CSDM_prop.matrix,N,title="Propagation Image")
