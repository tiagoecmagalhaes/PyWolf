...
class Canvas_sourceImage:
    ...
    def __init__(self,ui,W_matrix,N,title="Image"):
        ...
        try:
            ...
            ui.scrollArea_sourceImage = QtWidgets.QScrollArea(ui.list_of_tabs[-1])
            ...
            ui.scrollArea_sourceImageOpt = QtWidgets.QScrollArea(ui.list_of_tabs[-1])
            ...
            ui.list_grid_tabs[-1].addWidget(ui.scrollArea_sourceImage, 1, 0, 1, 1)
            ui.list_grid_tabs[-1].addWidget(ui.scrollArea_sourceImageOpt, 3, 0, 1, 1)
