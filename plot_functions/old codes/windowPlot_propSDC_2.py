...
class Canvas_propSDC:
    ...
    def __init__(self,ui,W_matrix,N):
        ...
        #=======================================================================
        ui.scrollArea_propSDC = QtWidgets.QScrollArea(ui.tab_plotPropSDC)
        ui.scrollArea_propSDC.setPalette(palette_scrollPlotProp)
        ui.scrollArea_propSDC.setWidgetResizable(True)
        ui.scrollArea_propSDC.setSizePolicy(QtWidgets.QSizePolicy.Minimum,QtWidgets.QSizePolicy.Minimum)
        ui.scrollArea_propSDC.setObjectName("scrollArea_propSDC")

        # Scroll Area Options prop
        ui.scrollArea_propSDCOpt = QtWidgets.QScrollArea(ui.tab_plotPropSDC)
        ...
        ui.scrollAreaWidgetContents_propSDCOpt.setObjectName("scrollAreaWidgetContents_propSDCOpt")
        ui.scrollArea_propSDCOpt.setWidget(ui.scrollAreaWidgetContents_propSDCOpt)

        ui.gridLayout_propSDCOpt = QtWidgets.QGridLayout(ui.scrollAreaWidgetContents_propSDCOpt)
        ui.gridLayout_propSDCOpt.setObjectName("gridLayout_propSDCOpt")

        ui.gridLayout_TabPropSDC.addWidget(ui.scrollArea_propSDC, 3, 0, 1, 1)
        ui.gridLayout_TabPropSDC.addWidget(ui.scrollArea_propSDCOpt, 10, 0, 1, 1)

        # Scroll Area Propagation SDC Phase
        ui.scrollArea_propSDC_phase = QtWidgets.QScrollArea(ui.tab_plotPropSDC)
        ui.scrollArea_propSDC_phase.setPalette(palette_scrollPlotProp)
        ui.scrollArea_propSDC_phase.setWidgetResizable(True)
        ui.scrollArea_propSDC_phase.setSizePolicy(QtWidgets.QSizePolicy.Minimum,QtWidgets.QSizePolicy.Minimum)
        ui.scrollArea_propSDC_phase.setObjectName("scrollArea_propSDC_phase")

        # Scroll Area Options Propagation SDC Phase
        ui.scrollArea_propSDCOpt_phase = QtWidgets.QScrollArea(ui.tab_plotPropSDC)
        ui.scrollArea_propSDCOpt_phase.setWidgetResizable(True)
        ui.scrollArea_propSDCOpt_phase.setObjectName("scrollArea_propImageOpt_phase")
        ...
        ui.scrollAreaWidgetContents_propSDCOpt_phase.setObjectName("scrollAreaWidgetContents_propSDCOpt_phase")
        ui.scrollArea_propSDCOpt_phase.setWidget(ui.scrollAreaWidgetContents_propSDCOpt_phase)

        ui.gridLayout_propSDCOpt_phase = QtWidgets.QGridLayout(ui.scrollAreaWidgetContents_propSDCOpt_phase)
        ui.gridLayout_propSDCOpt_phase.setObjectName("gridLayout_propSDCOpt_phase")

        ui.gridLayout_TabPropSDC.addWidget(ui.scrollArea_propSDC_phase, 3, 1, 1, 1)
        ui.gridLayout_TabPropSDC.addWidget(ui.scrollArea_propSDCOpt_phase, 10, 1, 1, 1)
        #_______________________________________________________________________
    ...
    def matrix_points(self):
        ...
        self.label_P1x.setText("Point 1 -x ")
        ...
        self.label_P1y.setText("Point 1 - y")
        self.gridLayout_points.addWidget(self.label_P1y, 4, 0, 1, 1,alignment=QtCore.Qt.AlignLeft)
        """
        ...
        """
        # label Point P2x
        self.label_P2x = QtWidgets.QLabel(self.parentOptions)
        self.label_P2x.setObjectName("label_P2x")
        self.label_P2x.setText("Point 2 - x")
        self.gridLayout_points.addWidget(self.label_P2x, 6, 0, 1, 1,alignment=QtCore.Qt.AlignLeft)
        """
    ...
    def update_pcolor(self):
        try:
            # creating image prop
            self.propSDC_mag   = sqrt(self.W_matrix[self.P1x,self.P1y].real**2+self.W_matrix[self.P1x,self.P1y].imag**2)
