...
class Canvas_sourceSDC:
    ...
    def __init__(self,ui,W_matrix,N):
        ...
        ui.scrollArea_sourceSDCOpt = QtWidgets.QScrollArea(ui.tab_plotSourceSDC)
        ...
        ui.gridLayout_TabSourceSDC.addWidget(ui.scrollArea_sourceSDC, 3, 0, 1, 1)
        ui.gridLayout_TabSourceSDC.addWidget(ui.scrollArea_sourceSDCOpt, 10, 0, 1, 1)

        # Scroll Area Source SDC Phase
        ui.scrollArea_sourceSDC_phase = QtWidgets.QScrollArea(ui.tab_plotSourceSDC)
        ...
        ui.scrollArea_sourceSDCOpt_phase = QtWidgets.QScrollArea(ui.tab_plotSourceSDC)
        ...
        ui.gridLayout_TabSourceSDC.addWidget(ui.scrollArea_sourceSDC_phase, 3, 1, 1, 1)
        ui.gridLayout_TabSourceSDC.addWidget(ui.scrollArea_sourceSDCOpt_phase, 10, 1, 1, 1)
    ...
    def build_fig(self):
        ...
        self.ui.gridLayout_TabSourceSDC.addWidget(self.mpl_toolbar, 8, 0, 1, 3,alignment=QtCore.Qt.AlignLeft)
        self.ui.gridLayout_TabSourceSDC.addWidget(self.mpl_toolbar_phase, 8, 1, 1, 3,alignment=QtCore.Qt.AlignLeft)
