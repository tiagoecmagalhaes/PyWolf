...
class Canvas_propSDC2D:
    ...
    def __init__(self,ui,W_matrix,N):
        ...
        ui.gridLayout_TabPropSDC2D.addWidget(ui.scrollArea_propSDCOpt, 10, 0, 1, 1)

        # Scroll Area Propagation SDC Phase
        ui.scrollArea_propSDC_phase = QtWidgets.QScrollArea(ui.tab_plotPropSDC2D)
        ...
        ui.scrollArea_propSDCOpt_phase = QtWidgets.QScrollArea(ui.tab_plotPropSDC2D)
        ...
        ui.gridLayout_TabPropSDC2D.addWidget(ui.scrollArea_propSDC_phase, 3, 1, 1, 1)
        ui.gridLayout_TabPropSDC2D.addWidget(ui.scrollArea_propSDCOpt_phase, 10, 1, 1, 1)
    ...
    def build_fig(self):
        ...
        self.ui.gridLayout_TabPropSDC2D.addWidget(self.mpl_toolbar, 8, 0, 1, 3,alignment=QtCore.Qt.AlignLeft)
        self.ui.gridLayout_TabPropSDC2D.addWidget(self.mpl_toolbar_phase, 8, 1, 1, 3,alignment=QtCore.Qt.AlignLeft)
