...
class Canvas_sourceImage:
    ...
    def __init__(self,ui,W_matrix,N):
        ...
        ui.list_grid_tabs.append(QtWidgets.QGridLayout(self.tab_plotSourceImage))
        ui.list_grid_tabs[-1].setObjectName("gridLayout_TabSourceImage")


        # Scroll Area Source Image
        ui.scrollArea_sourceImage = QtWidgets.QScrollArea(ui.tab_plotSourceImage)
        ui.scrollArea_sourceImage.setPalette(palette_scrollPlotProp)
        ui.scrollArea_sourceImage.setWidgetResizable(True)
        ui.scrollArea_sourceImage.setSizePolicy(QtWidgets.QSizePolicy.Minimum,QtWidgets.QSizePolicy.Minimum)
        ui.scrollArea_sourceImage.setObjectName("scrollArea_sourceImage")

        # Scroll Area Options Source
        ui.scrollArea_sourceImageOpt = QtWidgets.QScrollArea(ui.tab_plotSourceImage)
        ...
        ui.scrollAreaWidgetContents_sourceImageOpt.setObjectName("scrollAreaWidgetContents_sourceImageOpt")
        ui.scrollArea_sourceImageOpt.setWidget(ui.scrollAreaWidgetContents_sourceImageOpt)

        ui.gridLayout_sourceImageOpt = QtWidgets.QGridLayout(ui.scrollAreaWidgetContents_sourceImageOpt)
        ui.gridLayout_sourceImageOpt.setObjectName("gridLayout_sourceImageOpt")



        ui.gridLayout_TabSourceImage.addWidget(ui.scrollArea_sourceImage, 1, 0, 1, 1)
        ui.gridLayout_TabSourceImage.addWidget(ui.scrollArea_sourceImageOpt, 3, 0, 1, 1)
    ...
    def build_fig(self,W_matrix,N):
        ...
        self.ui.gridLayout_TabSourceImage.addWidget(self.mpl_toolbar, 2, 0, 1, 3)
        #_______________________________________________________________________
