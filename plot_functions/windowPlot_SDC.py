...
class Canvas_SDC:
    ...
    def __init__(self,ui,W_matrix,N,dx,title):

        #=======================================================================
        # Tab Plot
        #=======================================================================
        ui.list_of_tabs.append(QtWidgets.QWidget())              #self.tab_plotSourceSDC2D = QtWidgets.QWidget()
        ui.list_of_tabs[-1].setObjectName("tab_plotSDC") #self.tab_plotSourceSDC2D.setObjectName("tab_plotSourceSDC2D")

        ui.list_grid_tabs.append(QtWidgets.QGridLayout(ui.list_of_tabs[-1])) # self.gridLayout_TabSourceSDC2D = QtWidgets.QGridLayout(self.tab_plotSourceSDC2D)
        ui.list_grid_tabs[-1].setObjectName("gridLayout_TabSDC")     # self.gridLayout_TabSourceSDC2D.setObjectName("gridLayout_TabSourceSDC2D")
        ...
        #=======================================================================
        self.scrollArea_propSDC = QtWidgets.QScrollArea(ui.list_of_tabs[-1])
        ...
        self.scrollArea_propSDCOpt = QtWidgets.QScrollArea(ui.list_of_tabs[-1])
        ...
        ui.list_grid_tabs[-1].addWidget(self.scrollArea_propSDC, 3, 0, 1, 1)
        ui.list_grid_tabs[-1].addWidget(self.scrollArea_propSDCOpt, 10, 0, 1, 1)

        # Scroll Area Propagation SDC Phase
        self.scrollArea_propSDC_phase = QtWidgets.QScrollArea(ui.list_of_tabs[-1])
        ...
        self.scrollArea_propSDCOpt_phase = QtWidgets.QScrollArea(ui.list_of_tabs[-1])
        ...
        ui.list_grid_tabs[-1].addWidget(self.scrollArea_propSDC_phase, 3, 1, 1, 1)
        ui.list_grid_tabs[-1].addWidget(self.scrollArea_propSDCOpt_phase, 10, 1, 1, 1)
        #_______________________________________________________________________
    ...
    def build_fig(self):
        ...
        self.propSDC_mag = zeros((self.N),dtype=float)
        S1 = abs(self.W_matrix[self.P1x,self.P1y,self.P1x,self.P1y].real)
        for i in range(0,self.N):
            S2 = abs(self.W_matrix[self.P2x,i,self.P2x,i].real)
        ...
        self.b_array -= int(self.N/2)
        self.b_array *= self.dx

        # PLOT magnitude
        self.im, = self.axes.plot(self.b_array,self.propSDC_mag,marker="o",linewidth=1.0,label="SDC Mag")
        #self.cbar = self.fig.colorbar(self.im)
        self.leg = self.axes.legend()

        # PLOT phase
        self.im_phase, = self.axes_phase.plot(self.b_array,self.propSDC_phase,marker="o",linewidth=1.0,label="SDC Phase")
    ...
    def figure_options(self):
        ...
        # label xticks
        self.label_xticks = QtWidgets.QLabel(self.parentOptions)
        self.label_xticks.setObjectName("label_xticks")
        self.label_xticks.setText("x-ticks: ")
        self.gridOptions.addWidget(self.label_xticks, 44, 0, 1, 1,alignment=QtCore.Qt.AlignLeft)

        # -- line xticks Original --
        self.lineEdit_xticksOr = QtWidgets.QLineEdit(self.parentOptions)
        self.lineEdit_xticksOr.setObjectName("label_xticksOr")
        self.gridOptions.addWidget(self.lineEdit_xticksOr,44, 1, 1, 1,alignment=QtCore.Qt.AlignLeft)
        #self.lineEdit_linewidth.setText(str(1.0))

        # -- line xticks New --
        self.lineEdit_xticksNew = QtWidgets.QLineEdit(self.parentOptions)
        self.lineEdit_xticksNew.setObjectName("label_xticksNew")
        self.gridOptions.addWidget(self.lineEdit_xticksNew,44, 2, 1, 1,alignment=QtCore.Qt.AlignLeft)
        self.lineEdit_xticksOr.textChanged.connect(functools.partial(self.change_xticks,"mag"))
        self.lineEdit_xticksNew.textChanged.connect(functools.partial(self.change_xticks,"mag"))
        #self.lineEdit_linewidth.setText(str(1.0))

        # -- label yticks --
        self.label_yticks = QtWidgets.QLabel(self.parentOptions)
        self.label_yticks.setObjectName("label_yticks")
        self.label_yticks.setText("y-ticks: ")
        self.gridOptions.addWidget(self.label_yticks, 46, 0, 1, 1,alignment=QtCore.Qt.AlignLeft)

        # -- line yticks Original --
        self.lineEdit_yticksOr = QtWidgets.QLineEdit(self.parentOptions)
        self.lineEdit_yticksOr.setObjectName("label_yticksOr")
        self.gridOptions.addWidget(self.lineEdit_yticksOr,46, 1, 1, 1,alignment=QtCore.Qt.AlignLeft)
        #self.lineEdit_linewidth.setText(str(1.0))

        # line yticks New
        self.lineEdit_yticksNew = QtWidgets.QLineEdit(self.parentOptions)
        self.lineEdit_yticksNew.setObjectName("label_yticksNew")
        self.gridOptions.addWidget(self.lineEdit_yticksNew,46, 2, 1, 1,alignment=QtCore.Qt.AlignLeft)
        #self.lineEdit_linewidth.setText(str(1.0))
        self.lineEdit_yticksOr.textChanged.connect(functools.partial(self.change_yticks,"mag"))
        self.lineEdit_yticksNew.textChanged.connect(functools.partial(self.change_yticks,"mag"))
        #_______________________________________________________________________
    ...
    def figure_options_phase(self):
        try:
            ...
            # label xticks
            self.label_xticks_phase = QtWidgets.QLabel(self.parentOptions)
            self.label_xticks_phase.setObjectName("label_xticks_phase")
            self.label_xticks_phase.setText("x-ticks: ")
            self.gridOptions_phase.addWidget(self.label_xticks_phase, 44, 0, 1, 1,alignment=QtCore.Qt.AlignLeft)

            # -- line xticks Original --
            self.lineEdit_xticksOr_phase = QtWidgets.QLineEdit(self.parentOptions)
            self.lineEdit_xticksOr_phase.setObjectName("label_xticksOr")
            self.gridOptions_phase.addWidget(self.lineEdit_xticksOr_phase,44, 1, 1, 1,alignment=QtCore.Qt.AlignLeft)
            #self.lineEdit_linewidth.setText(str(1.0))

            # -- line xticks New --
            self.lineEdit_xticksNew_phase = QtWidgets.QLineEdit(self.parentOptions)
            self.lineEdit_xticksNew_phase.setObjectName("label_xticksNew_phase")
            self.gridOptions_phase.addWidget(self.lineEdit_xticksNew_phase,44, 2, 1, 1,alignment=QtCore.Qt.AlignLeft)
            self.lineEdit_xticksOr_phase.textChanged.connect(functools.partial(self.change_xticks,"phase"))
            self.lineEdit_xticksNew_phase.textChanged.connect(functools.partial(self.change_xticks,"phase"))
            #self.lineEdit_linewidth.setText(str(1.0))

            # -- label yticks - Phase --
            self.label_yticks_phase = QtWidgets.QLabel(self.parentOptions)
            self.label_yticks_phase.setObjectName("label_yticks_phase")
            self.label_yticks_phase.setText("y-ticks: ")
            self.gridOptions_phase.addWidget(self.label_yticks_phase, 46, 0, 1, 1,alignment=QtCore.Qt.AlignLeft)

            # -- line yticks Original - Phase--
            self.lineEdit_yticksOr_phase = QtWidgets.QLineEdit(self.parentOptions)
            self.lineEdit_yticksOr_phase.setObjectName("label_yticksOr_phase")
            self.gridOptions_phase.addWidget(self.lineEdit_yticksOr_phase,46, 1, 1, 1,alignment=QtCore.Qt.AlignLeft)
            #self.lineEdit_linewidth.setText(str(1.0))

            # -- line yticks New - Phase --
            self.lineEdit_yticksNew_phase = QtWidgets.QLineEdit(self.parentOptions)
            self.lineEdit_yticksNew_phase.setObjectName("label_yticksNew_phase")
            self.gridOptions_phase.addWidget(self.lineEdit_yticksNew_phase,46, 2, 1, 1,alignment=QtCore.Qt.AlignLeft)
            #self.lineEdit_linewidth.setText(str(1.0))
            self.lineEdit_yticksOr_phase.textChanged.connect(functools.partial(self.change_yticks,"phase"))
            self.lineEdit_yticksNew_phase.textChanged.connect(functools.partial(self.change_yticks,"phase"))
            #_______________________________________________________________________
                ...
                if self.P1y>=0 and self.P1y<self.N:
                    if self.P2x>=0 and self.P2x<self.N:
                        ...
                        for i in range(0,self.N):
                            S2 = abs(self.W_matrix[self.P2x,i,self.P2x,i].real)
                            if S1!=0.0 and S2!=0.0:
                                self.propSDC_mag[i]   = sqrt(self.W_matrix[self.P1x,self.P1y,self.P2x,i].real**2+self.W_matrix[self.P1x,self.P1y,self.P2x,i].imag**2)/sqrt(S1*S2)
    ...
    def change_xticks(self,graph):
        ...
        try:
            ...
            if graph =="mag":
                ## original xticks
                original = []
                temp_or = self.lineEdit_xticksOr.text()
                Nl = len(temp_or)
                actual=""
                for i in range(0,Nl):
                    if temp_or[i]==",":
                        original.append(float(actual))
                        actual=""
                    elif i==Nl-1:
                        actual+=temp_or[i]
                        original.append(float(actual))
                        ...
                        actual+=temp_or[i]
                self.ui.update_outputText(str(original))

                ## new xticks
                new = []
                temp_new = self.lineEdit_xticksNew.text()
                Nl = len(temp_new)
                actual=""
                for i in range(0,Nl):
                    if temp_new[i]==",":
                        ...
                        actual+=temp_new[i]
                self.ui.update_outputText(str(new))

                self.axes.set_xticks(original)
                self.axes.set_xticklabels(new)
                self.canvas.draw()
            ...
            #
                ...
                ## original xticks
                original = []
                temp_or = self.lineEdit_xticksOr_phase.text()
                Nl = len(temp_or)
                actual=""
                for i in range(0,Nl):
                    if temp_or[i]==",":
                ...
                ## new xticks
                new = []
                temp_new = self.lineEdit_xticksNew_phase.text()
                Nl = len(temp_new)
                actual=""
                for i in range(0,Nl):
                    if temp_new[i]==",":
                ...
                self.axes_phase.set_xticks(original)
                self.axes_phase.set_xticklabels(new)
                self.canvas_phase.draw()
    ...
    def change_yticks(self,graph):
        try:
            ...
            if graph =="mag":
                ...
                ## original yticks
                original = []
                temp_or = self.lineEdit_yticksOr.text()
                Nl = len(temp_or)
                actual=""
                for i in range(0,Nl):
                    if temp_or[i]==",":
                ...
                ## new yticks
                new = []
                temp_new = self.lineEdit_yticksNew.text()
                Nl = len(temp_new)
                actual=""
                for i in range(0,Nl):
                    if temp_new[i]==",":
                ...
                self.axes.set_yticks(original)
                self.axes.set_yticklabels(new)
                self.canvas.draw()
            ...
            # -- Phase --
                ...
                ## original yticks
                original = []
                temp_or = self.lineEdit_yticksOr_phase.text()
                Nl = len(temp_or)
                actual=""
                for i in range(0,Nl):
                    if temp_or[i]==",":
                ...
                ## new yticks
                new = []
                temp_new = self.lineEdit_yticksNew_phase.text()
                Nl = len(temp_new)
                actual=""
                for i in range(0,Nl):
                    if temp_new[i]==",":
                ...
                self.axes_phase.set_yticks(original)
                self.axes_phase.set_yticklabels(new)
                self.canvas_phase.draw()
