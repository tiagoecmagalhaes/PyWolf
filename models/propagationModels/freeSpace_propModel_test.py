                            ...
                            for i1 in range(0,N):
                                ...
                                for j1 in range(0,N):
                                    ...
                                    CL_qfunc.increase(queue,data_real.shape,None,result_real_gpu_memory,result_imag_gpu_memory,
                                                       ...
                                                       int32(N),int32(M),int32(i1),int32(j1),double(dlp),double(dx),
                                                       double(r1xx),double(r1yy),double(r2xx),double(r2yy),double(r1_x),double(r1_y),
                                    ...
                                    WW.real[i1,j1] = result_real.copy()
                                    WW.imag[i1,j1] = result_imag.copy()
